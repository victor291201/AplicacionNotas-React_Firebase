            ...
            <div className='container-fluid px-2 m-0' style={{width:"100%",height:"calc(100% - 50px)"}}>
                <div className='row p-0 m-0' style={{height:"100%",width:"100%"}}>
                    <div className='col-md-12 d-flex justify-content-center align-items-center'>
                        <div className="card" style={{width:400,height:520}}>
                            <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                <div className='my-4 d-flex flex-column justify-content-around align-items-center' style={{width:300,height:430}}>
                                <h5 className="card-title mb-3 mt-n3">Crear pendiente</h5>
                                    ...
                                    <select className="form-control" placeholder='Prioridad' id="prioridad">
                                        <option disabled selected>Encargados</option>
                                        <option>Estudiantes calculo G1</option>
                                        <option>Estudiantes calculo G2</option>
                                        <option>Estudiantes calculo G3</option>
                                    </select>
                                </div>
